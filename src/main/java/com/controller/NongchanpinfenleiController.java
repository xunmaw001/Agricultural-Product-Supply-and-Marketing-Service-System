...
public class NongchanpinfenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,NongchanpinfenleiEntity nongchanpinfenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,NongchanpinfenleiEntity nongchanpinfenlei, HttpServletRequest request){
        EntityWrapper<NongchanpinfenleiEntity> ew = new EntityWrapper<NongchanpinfenleiEntity>();
    	PageUtils page = nongchanpinfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, nongchanpinfenlei), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<NongchanpinfenleiEntity> wrapper = new EntityWrapper<NongchanpinfenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = nongchanpinfenleiService.selectCount(wrapper);
