...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">农产品资讯管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>农产品资讯列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">农产品资讯列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>封面</th>
											<th onclick="sort('laiyuan')">来源<i id="laiyuanIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('faburen')">发布人<i id="faburenIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
        ...
        function getDataList() {
			http("nongchanpinzixun/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			var laiyuanCell  = document.createElement('td');

						 laiyuanCell.innerHTML = item.laiyuan;


			row.appendChild(laiyuanCell);
			...
			var faburenCell  = document.createElement('td');

						 faburenCell.innerHTML = item.faburen;


			row.appendChild(faburenCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("nongchanpinzixun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"nongchanpinzixun");
