...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑农产品资讯</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>农产品资讯管理</span></li>
								<li class="breadcrumb-item active"><span>编辑农产品资讯</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">农产品资讯信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>来源</label>
										<input id="laiyuan" name="laiyuan" class="form-control" placeholder="来源">
									</div>
									<div class="form-group col-md-6">
										<label>发布时间</label>
									...
									<div class="form-group col-md-6">
										<label>发布人</label>
										<input id="faburen" name="faburen" class="form-control" placeholder="发布人">
									</div>
	...
	<script>
		...
		var tableName = "nongchanpinzixun";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "nongchanpinzixun/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("nongchanpinzixun/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("nongchanpinzixun/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("nongchanpinzixun"+colName,"GET",{
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.laiyuan != null && res.data.laiyuan != ''){

					$("#laiyuan").val(res.data.laiyuan);
					}
					...
					if(res.data != null && res.data != '' && res.data.faburen != null && res.data.faburen != ''){

					$("#faburen").val(res.data.faburen);
					}
