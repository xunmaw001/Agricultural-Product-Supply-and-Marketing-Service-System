...
<body>
  <div id="app">
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in nongchanpinList" v-bind:key="index" @click="jump('../nongchanpin/detail.jsp?id='+item.id)">
              <img :src="item.chanpintupian?item.chanpintupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.chanpinmingcheng}}</h6>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in nongchanpinzixunList" v-bind:key="index" @click="jump('../nongchanpinzixun/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`nongchanpin/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.nongchanpinList = res.data.list;
      });
      http.request(`nongchanpinzixun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.nongchanpinzixunList = res.data.list;
      });
    });
  </script>
</body>
