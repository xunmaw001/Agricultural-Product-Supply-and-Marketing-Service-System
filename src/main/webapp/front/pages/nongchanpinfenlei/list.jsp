      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="nongchanpinfenlei" id="nongchanpinfenlei" placeholder="农产品分类" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('nongchanpinfenlei','新增')" @click="jump('../nongchanpinfenlei/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../nongchanpinfenlei/detail.jsp?id='+item.id">
              <figure>
              </figure>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#nongchanpinfenlei').val()) {
          param['nongchanpinfenlei'] = jquery('#nongchanpinfenlei').val() ? '%' + jquery('#nongchanpinfenlei').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('nongchanpinfenlei/list', 'get', param, function(res) {
